...
const COMPANY_NAME = 'Tunisian Demo Bank';
...
const PROCESS_DEFINITIONS = [
  {
    ...
    name: 'BDT - Retail Distribution and Individual Credits',
    description:
      'Macro-process driving onboarding, retail distribution, and personal credit setup.',
    category: 'Retail Banking',
    laneNames: ['Distribution', 'Credit Risk', 'Retail Execution'],
    macroSteps: [
      { type: 'subProcess', processKey: 'account_opening', lane: 0 },
      { type: 'subProcess', processKey: 'consumer_loan', lane: 1 },
      { type: 'serviceTask', name: 'Retail Portfolio Management', lane: 2 },
    ],
  },
  {
    ...
    kind: 'macro',
    owner: 'bdt_ops',
    name: 'BDT - Payments, Monetics, and Back Office',
    description:
      'Macro-process covering payments, international transfers, monetics, and back-office relations.',
    category: 'Operations',
    laneNames: ['Front Office', 'Monetics and Payments', 'Back Office'],
    macroSteps: [
      { type: 'subProcess', processKey: 'international_transfer', lane: 2 },
      { type: 'subProcess', processKey: 'card_dispute', lane: 1 },
      { type: 'userTask', name: 'Operational Incidents Supervision', lane: 0 },
    ],
  },
  {
    ...
    name: 'BDT - Governance, Risks, and Compliance',
    description:
      'Macro-process for oversight including compliance, AML-CFT alert management, and risk supervision.',
    category: 'Compliance',
    laneNames: ['Monitoring', 'Compliance', 'Risk Committee'],
    macroSteps: [
      { type: 'serviceTask', name: 'Regulatory Monitoring', lane: 0 },
      { type: 'subProcess', processKey: 'aml_alert', lane: 1 },
      { type: 'userTask', name: 'Risk Committee and Action Plans', lane: 2 },
    ],
  },
  {
    key: 'account_opening',
    ...
    owner: 'bdt_branch_mgr',
    name: 'BDT - Individual Current Account Opening',
    description:
      'Retail branch account opening with document control, KYC screening, core banking setup, and customer activation.',
    category: 'Retail Banking',
    laneNames: ['Branch', 'KYC Compliance', 'Retail Back Office'],
    customerAction: 'Submit opening application',
    customerReply: 'Receive activation and Bank Account Details (RIB)',
    stepTypes: ['receiveTask', 'userTask', 'subProcess', 'serviceTask', 'userTask', 'sendTask'],
    lanePattern: [0, 0, 1, 2, 0, 2],
    taskNames: [
      'Welcome customer at branch',
      'Verify ID and documents',
      'KYC and AML-CFT check',
      'Create customer and account in core banking',
      'Sign agreements and initial deposit',
      'Account activation and RIB delivery',
    ],
  },
  {
    key: 'consumer_loan',
    ...
    parentKey: 'macro_retail',
    owner: 'bdt_credit',
    name: 'BDT - Consumer Loan Granting',
    description:
      'Consumer-loan workflow from application receipt to scoring, risk review, decision, contract, and disbursement.',
    category: 'Credit',
    laneNames: ['Commercial', 'Credit Risk', 'Disbursement'],
    customerAction: 'Submit loan application',
    customerReply: 'Receive decision and contract',
    stepTypes: ['receiveTask', 'userTask', 'serviceTask', 'subProcess', 'subProcess', 'sendTask'],
    lanePattern: [0, 0, 1, 1, 1, 2],
    taskNames: [
      'Receive loan application',
      'Review file and income',
      'Internal scoring',
      'Credit risk analysis',
      'Delegation or committee decision',
      'Contract issuance and disbursement',
    ],
  },
  {
  ...
  },
  {
    ...
    owner: 'bdt_compliance',
    name: 'BDT - AML-CFT Alert Review',
    description:
      'AML alert review for transaction monitoring, enhanced due diligence, escalation, and closure.',
    category: 'Compliance',
    laneNames: ['Monitoring', 'Compliance Analyst', 'AML-CFT Manager'],
    customerAction: 'Monitoring signal',
    customerReply: 'Close alert',
    ...
    taskNames: [
      ...
      'Escalate to compliance if necessary',
      'Close alert',
    ],
  },
];
...
const SCENARIO_DEFINITIONS = [
  {
    ...
    name: 'BDT - Tunis City Center Branch - Standard Day',
    ...
    planningTarget: 85,
    resources: [
      { key: 'advisor', name: 'Branch Customer Advisor', resource_type: 'human', quantity: 3, cost_per_hour: 38, availability: 95, availability_windows: [] },
      { key: 'kyc', name: 'KYC Analyst', resource_type: 'human', quantity: 2, cost_per_hour: 42, availability: 94, availability_windows: [] },
      { key: 'core', name: 'Retail Core Banking', resource_type: 'system', quantity: 1, cost_per_hour: 12, availability: 99, availability_windows: [{ start: '08:00', end: '16:30', days: [1, 2, 3, 4, 5] }] },
      { key: 'backoffice', name: 'Back Office Operations', resource_type: 'human', quantity: 2, cost_per_hour: 29, availability: 96, availability_windows: [] },
    ],
    tasks: [
      { task_id: 'Task_1', task_name: 'Welcome customer at branch', duration_min: 6, duration_type: 'normal', duration_std: 1.5, resource: 'advisor', cost: 6, sla_target_min: 12 },
      { task_id: 'Task_2', task_name: 'Verify ID and documents', duration_min: 12, duration_type: 'normal', duration_std: 3, resource: 'advisor', cost: 8, sla_target_min: 18 },
      { task_id: 'Task_3', task_name: 'KYC and AML-CFT check', duration_min: 10, duration_type: 'normal', duration_std: 2, resource: 'kyc', cost: 10, sla_target_min: 18 },
      { task_id: 'Task_4', task_name: 'Create customer and account in core banking', duration_min: 8, duration_type: 'fixed', duration_std: 0, resource: 'core', cost: 4, sla_target_min: 12 },
      { task_id: 'Task_5', task_name: 'Sign agreements and initial deposit', duration_min: 15, duration_type: 'normal', duration_std: 3, resource: 'advisor', cost: 9, sla_target_min: 20 },
      { task_id: 'Task_6', task_name: 'Account activation and RIB delivery', duration_min: 7, duration_type: 'fixed', duration_std: 0, resource: 'backoffice', cost: 4, sla_target_min: 12 },
    ],
  },
  {
    processKey: 'consumer_loan',
    name: 'BDT - Consumer Loan - Monthly Baseline',
    ...
    planningTarget: 300,
    resources: [
      { key: 'credit_advisor', name: 'Loan Advisor', resource_type: 'human', quantity: 3, cost_per_hour: 45, availability: 94, availability_windows: [] },
      { key: 'scoring', name: 'Scoring Engine', resource_type: 'system', quantity: 1, cost_per_hour: 16, availability: 99, availability_windows: [{ start: '08:00', end: '16:30', days: [1, 2, 3, 4, 5] }] },
      { key: 'risk', name: 'Credit Risk Analyst', resource_type: 'human', quantity: 2, cost_per_hour: 55, availability: 93, availability_windows: [] },
      { key: 'committee', name: 'Credit Delegation or Committee', resource_type: 'human', quantity: 1, cost_per_hour: 70, availability: 90, availability_windows: [{ start: '09:30', end: '12:30', days: [1, 2, 3, 4, 5] }] },
      { key: 'disbursement', name: 'Disbursement Operations', resource_type: 'human', quantity: 2, cost_per_hour: 34, availability: 95, availability_windows: [] },
    ],
    tasks: [
      { task_id: 'Task_1', task_name: 'Receive loan application', duration_min: 18, duration_type: 'normal', duration_std: 4, resource: 'credit_advisor', cost: 12, sla_target_min: 30 },
      { task_id: 'Task_2', task_name: 'Review file and income', duration_min: 24, duration_type: 'normal', duration_std: 6, resource: 'credit_advisor', cost: 14, sla_target_min: 40 },
      { task_id: 'Task_3', task_name: 'Internal scoring', duration_min: 5, duration_type: 'fixed', duration_std: 0, resource: 'scoring', cost: 4, sla_target_min: 10 },
      { task_id: 'Task_4', task_name: 'Credit risk analysis', duration_min: 45, duration_type: 'normal', duration_std: 8, resource: 'risk', cost: 18, sla_target_min: 60 },
      { task_id: 'Task_5', task_name: 'Delegation or committee decision', duration_min: 35, duration_type: 'uniform', duration_std: 0, resource: 'committee', cost: 12, sla_target_min: 55 },
      { task_id: 'Task_6', task_name: 'Contract issuance and disbursement', duration_min: 28, duration_type: 'normal', duration_std: 5, resource: 'disbursement', cost: 11, sla_target_min: 40 },
    ],
  },
  {
    processKey: 'consumer_loan',
    name: 'BDT - Consumer Loan - Salary Campaign',
    ...
    tasks: [
      { task_id: 'Task_1', task_name: 'Receive loan application', duration_min: 19, duration_type: 'normal', duration_std: 4, resource: 'credit_advisor', cost: 12, sla_target_min: 30 },
      { task_id: 'Task_2', task_name: 'Review file and income', duration_min: 26, duration_type: 'normal', duration_std: 6, resource: 'credit_advisor', cost: 14, sla_target_min: 40 },
      { task_id: 'Task_3', task_name: 'Internal scoring', duration_min: 5, duration_type: 'fixed', duration_std: 0, resource: 'scoring', cost: 4, sla_target_min: 10 },
      { task_id: 'Task_4', task_name: 'Credit risk analysis', duration_min: 48, duration_type: 'normal', duration_std: 9, resource: 'risk', cost: 18, sla_target_min: 60 },
      { task_id: 'Task_5', task_name: 'Delegation or committee decision', duration_min: 38, duration_type: 'uniform', duration_std: 0, resource: 'committee', cost: 12, sla_target_min: 55 },
      { task_id: 'Task_6', task_name: 'Contract issuance and disbursement', duration_min: 30, duration_type: 'normal', duration_std: 6, resource: 'disbursement', cost: 11, sla_target_min: 40 },
    ],
  },
];
...
function buildEmbeddedSubProcess(step, options = {}) {
  const labels = options.labels?.length
    ...
    : [
        `Prepare ${shortWords(step.name, 2)}`.trim(),
        `Process ${shortWords(step.name, 2)}`.trim(),
        `Validate ${shortWords(step.name, 2)}`.trim(),
      ];
  ...
  return {
    xml: `<bpmn:subProcess id="${step.id}" name="${escapeXml(step.name)}"><bpmn:incoming>${step.incoming}</bpmn:incoming><bpmn:outgoing>${step.outgoing}</bpmn:outgoing><bpmn:startEvent id="${startId}" name="Start"><bpmn:outgoing>${flow1Id}</bpmn:outgoing></bpmn:startEvent><bpmn:userTask id="${task1Id}" name="${escapeXml(labels[0] || 'Preparation')}"><bpmn:incoming>${flow1Id}</bpmn:incoming><bpmn:outgoing>${flow2Id}</bpmn:outgoing></bpmn:userTask><bpmn:serviceTask id="${task2Id}" name="${escapeXml(labels[1] || labels[2] || 'Processing')}"><bpmn:incoming>${flow2Id}</bpmn:incoming><bpmn:outgoing>${flow3Id}</bpmn:outgoing></bpmn:serviceTask><bpmn:endEvent id="${endId}" name="End"><bpmn:incoming>${flow3Id}</bpmn:incoming></bpmn:endEvent><bpmn:sequenceFlow id="${flow1Id}" sourceRef="${startId}" targetRef="${task1Id}" /><bpmn:sequenceFlow id="${flow2Id}" sourceRef="${task1Id}" targetRef="${task2Id}" /><bpmn:sequenceFlow id="${flow3Id}" sourceRef="${task2Id}" targetRef="${endId}" /></bpmn:subProcess>`,
    di: [
...
<bpmn:definitions xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" id="Definitions_${definition.key}" targetNamespace="http://demo.bdt.tn/bpmn">
  ...
  <bpmn:process id="${processId}" name="${escapeXml(definition.name)}" isExecutable="false">
    ...
    ${nodeMarkup}
    <bpmn:endEvent id="EndEvent_1" name="End"><bpmn:incoming>Flow_${steps.length + 1}</bpmn:incoming></bpmn:endEvent>
    ${flows.join('')}
  </bpmn:process>
  ...
  const bankNodeMarkup = steps
    .map((step, index) => {
      ...
      if (step.type === 'subProcess') {
        const embedded = buildEmbeddedSubProcess(step, {
          labels: [
            `Verify ${shortWords(step.name, 2)}`,
            `Process ${shortWords(step.name, 2)}`,
            `Validate ${shortWords(step.name, 2)}`,
          ],
        });
        subprocessEmbeds.push(...embedded.di);
        return embedded.xml;
...
<bpmn:definitions xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" id="Definitions_${definition.key}" targetNamespace="http://demo.bdt.tn/bpmn">
  <bpmn:collaboration id="${collaborationId}">
    ...
    <bpmn:participant id="${bankParticipantId}" name="Tunisian Demo Bank" processRef="${bankProcessId}" />
  ...
  <bpmn:process id="${clientProcessId}" name="Client" isExecutable="false">
    <bpmn:startEvent id="StartEvent_Client" name="Start" />
    <bpmn:sendTask id="${clientTaskId}" name="${escapeXml(definition.customerAction || 'Send request')}" />
    <bpmn:intermediateCatchEvent id="${clientReceiveId}" name="${escapeXml(definition.customerReply || 'Receive feedback')}" />
    <bpmn:endEvent id="EndEvent_Client" name="End" />
    ${clientFlows.join('')}
  </bpmn:process>
  <bpmn:process id="${bankProcessId}" name="${escapeXml(definition.name)}" isExecutable="false">
    ...
    ${bankNodeMarkup}
    <bpmn:endEvent id="EndEvent_1" name="Closure"><bpmn:incoming>Flow_${steps.length + 1}</bpmn:incoming></bpmn:endEvent>
    ${bankFlows.join('')}
  </bpmn:process>
  <bpmndi:BPMNDiagram id="BPMNDiagram_${definition.key}">
    <bpmndi:BPMNPlane id="BPMNPlane_${definition.key}" bpmnElement="${collaborationId}">
...
async function createProcess({ companyId, categoryId, createdBy, definition, parentId, definitionsByKey }) {
  ...
  await pool.query(
    ...
    [
      process.id,
      definition.kind === 'macro'
        ? 'Macro-process approved with decomposition into sub-processes.'
        : 'Detailed sub-process approved with banking BPMN diagram.',
      createdBy,
    ]
  );
...
async function createOrgChart(companyId, usersByUsername) {
  ...
  const nodes = [
    { key: 'company', parent: null, name: COMPANY_NAME, title: 'Universal Bank', node_type: 'company', color: '#dc2626' },
    { key: 'executive', parent: 'company', name: 'General Management', title: 'Strategic Oversight', node_type: 'division', color: '#2563eb' },
    { key: 'branch_network', parent: 'company', name: 'Branch Network', title: 'Retail Distribution', node_type: 'division', color: '#2563eb' },
    { key: 'credits', parent: 'company', name: 'Retail Credit Division', title: 'Personal Credit', node_type: 'division', color: '#2563eb' },
    { key: 'operations', parent: 'company', name: 'Banking Operations', title: 'Back Office and Execution', node_type: 'division', color: '#2563eb' },
    { key: 'compliance', parent: 'company', name: 'Compliance and AML-CFT', title: 'Permanent Control', node_type: 'division', color: '#2563eb' },
    { key: 'agency_tunis', parent: 'branch_network', name: 'Tunis City Center Branch', title: 'Urban Public Branch', node_type: 'department', color: '#7c3aed' },
    { key: 'platform_admin', parent: 'executive', name: 'Platform Administration', title: 'Company administrator', node_type: 'position', user: 'bdt_admin', color: '#475569' },
    { key: 'branch_manager', parent: 'agency_tunis', name: 'Tunis City Center Branch Management', title: 'Branch Manager', node_type: 'position', user: 'bdt_branch_mgr', color: '#475569' },
    { key: 'credit_analyst', parent: 'credits', name: 'Credit Analysis Hub', title: 'Credit Risk Analyst', node_type: 'position', user: 'bdt_credit', color: '#475569' },
    { key: 'operations_manager', parent: 'operations', name: 'Retail Back Office Unit', title: 'Operations Manager', node_type: 'position', user: 'bdt_ops', color: '#475569' },
    { key: 'compliance_manager', parent: 'compliance', name: 'Compliance Unit', title: 'Compliance Manager', node_type: 'position', user: 'bdt_compliance', color: '#475569' },
    { key: 'reporting', parent: 'executive', name: 'Oversight and Reporting', title: 'Reporting Officer', node_type: 'position', user: 'bdt_viewer', color: '#475569' },
  ];
