...
describe('auth routes', () => {
  ...
  it('logs in successfully and returns aggregated permissions for active roles', async () => {
    ...
    expect(response.body.user.activeRoles).toEqual(['Business Analyst', 'Risk Manager']);
  ...
  it('lists users for a company administrator', async () => {
    ...
    expect(response.body).toEqual([
      expect.objectContaining({
        ...
        activeRoles: ['Viewer', 'Risk Manager'],
        additionalRoles: [
          expect.objectContaining({
            role: 'Risk Manager',
  ...
  it('creates, updates, and deletes users within company scope', async () => {
    ...
    expect(created.body.activeRoles).toEqual(['Viewer', 'Risk Manager']);
