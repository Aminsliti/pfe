...
-- Run with: node server/migrate-simulations.js
-- ═══════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS simulation_scenarios (
  ...
  -- Results, stored as JSON after execution
  results               JSONB,
...
-- Scenario resources: people, machines, and related capacity
...
CREATE TABLE IF NOT EXISTS simulation_flow_probabilities (
  ...
  probability     NUMERIC(5,2) DEFAULT 100,  -- percentage from 0 to 100
  created_at      TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
