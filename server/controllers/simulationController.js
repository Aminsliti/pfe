...
import { ensureSimulationSchema } from '../services/simulation/simulationSchema.js';
...
} from '../services/simulation/simulationReport.js';
...
function buildScenarioComparison(primaryScenario, secondaryScenario) {
  ...
  return {
    ...
    summary: [
      compareMetric('Average cycle time', 'avg_duration_min', primaryResults, secondaryResults, 'min'),
      compareMetric('P95', 'p95_duration_min', primaryResults, secondaryResults, 'min'),
      compareMetric('Total cost', 'total_cost', primaryResults, secondaryResults, 'EUR'),
      compareMetric('Cost / instance', 'avg_cost_per_instance', primaryResults, secondaryResults, 'EUR'),
      compareMetric('Max utilization', 'max_resource_utilization', primaryResults, secondaryResults, '%'),
    ],
