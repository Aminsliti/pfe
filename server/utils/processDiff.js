...
export function summarizeBpmnDefinition(bpmnXml = '') {
  ...
  return {
    tasks: countPattern(source, /<(?:[\w.-]+:)?(?:userTask|serviceTask|scriptTask|manualTask|sendTask|receiveTask|businessRuleTask|task|subProcess|adHocSubProcess|transaction|callActivity)\b/gi),
