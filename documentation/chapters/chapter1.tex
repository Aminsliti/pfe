...
Figure \ref{fig:org} illustrates the organizational structure of Vitalis.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{organigramme.png}
    \caption{Organizational chart of Vitalis}
    \label{fig:org}
\end{figure}

The project was carried out within the \textbf{[Department Name]} department, where the focus is on developing and integrating enterprise solutions related to BPM and GRC systems.
