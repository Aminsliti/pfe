...
\includegraphics[scale=1]{manageprocusecase.png}
%\vspace{2cm}}}
...
The authentication system design is illustrated through the following diagrams, which showcase the participating classes and their dynamic interactions during the authentication process.

\subsubsection{Class Diagram}

Figure~\ref{fig:class-auth} presents the static structure of the authentication module, displaying the main classes and their relationships within the system architecture.

% TODO: ADD AUTHENTICATION CLASS DIAGRAM
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{S'authetifier.png}
...
Figure~\ref{fig:seq-auth} demonstrates the dynamic interactions between objects during the authentication workflow, showing the sequence of operations from user input through database storage.

% TODO: ADD AUTHENTICATION SEQUENCE DIAGRAM
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{auth.png}
...
The user management functionality is demonstrated through the following diagrams, which highlight the classes responsible for handling user CRUD operations and their interactions within the system.

\subsubsection{Class Diagram}

Figure~\ref{fig:class-users} illustrates the static architecture of the user management module, showcasing the User entity and its associated services for comprehensive user administration.

% TODO: ADD USER MANAGEMENT CLASS DIAGRAM
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{gereruserclass.png}
...
Figure~\ref{fig:seq-users} depicts the dynamic interactions during user management operations, including the creation, modification, and deletion processes within the system.

% TODO: ADD USER MANAGEMENT SEQUENCE DIAGRAM
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{manage_users.png}
...
The category management system is presented through the following diagrams, emphasizing the hierarchical organization and the relationships between different organizational entities.

\subsubsection{Class Diagram}

Figure~\ref{fig:class-categories} represents the static structure of the category management module, displaying the Category entity and its relationships with other system components.

% TODO: ADD CATEGORY MANAGEMENT CLASS DIAGRAM
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{gerercatclass.png}
...
Figure~\ref{fig:seq-categories} demonstrates the sequential flow of category management operations, including creation, editing, deletion, and hierarchical reassignment processes.

% TODO: ADD CATEGORY MANAGEMENT SEQUENCE DIAGRAM
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{manage_categories.png}
...
The process management system design is showcased through the following diagrams, which encompass the complete business process lifecycle from creation through archiving.

\subsubsection{Class Diagram}

Figure~\ref{fig:class-process} displays the comprehensive structure of the process management module, including BPMN validation, version control, and archiving functionalities.

% TODO: ADD PROCESS MANAGEMENT CLASS DIAGRAM
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{gererprocclass.png}
...
Figure~\ref{fig:seq-process} illustrates the dynamic interactions during process management operations, including validation workflows and archiving processes within the system.

% TODO: ADD PROCESS MANAGEMENT SEQUENCE DIAGRAM
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{manage_process.png}
